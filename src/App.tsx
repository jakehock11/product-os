              ...
              <ErrorBoundary>
                <Routes>
                  <Route element={<AppShell />}>
                    ...
                    <Route
                      path="/product/:productId/captures/:id"
                      element={<QuickCaptureDetailPage />}
                    />
                    ...
                    {/* New entity detail pages */}
                    <Route
                      path="/product/:productId/feedback/:id"
                      element={<FeedbackDetailPage />}
                    />
                    <Route
                      path="/product/:productId/feature-requests/:id"
                      element={<FeatureRequestDetailPage />}
                    />
                    <Route
                      path="/product/:productId/features/:id"
