...
export default function TaxonomyPage() {
  ...
  const handleRestoreItem = async (type: TaxonomyItemType, id: string, name: string) => {
    if (!productId) return;
        ...
        {taxonomy.dimensions
          ...
          .map((dimension) => (
            <DimensionCard
              ...
              onRestoreDimension={() =>
                handleRestoreItem('dimension', dimension.id, dimension.name)
              }
              onArchiveValue={(item) =>
                setArchiveConfirm({
                  type: 'dimensionValue',
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This item will be hidden from tag pickers but will remain on existing entities. You
