...
import { Hammer, Search, FlaskConical, CheckCircle, Package, Plus } from 'lucide-react';
...
export default function WorkPage() {
  ...
  const handleCreate = async (type: EntityType) => {
    ...
    try {
      const defaultStatus =
        type === 'experiment' ? 'planned' : type === 'feature' ? 'building' : undefined;
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  {health && entity.type === 'feature' && (
                    <div
                      className={`h-2 w-2 rounded-full ${HEALTH_COLORS[health]}`}
